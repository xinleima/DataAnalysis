...
from clean_code import bad_noun_word
...
file_object = open('keyword_tfidf.txt','r',encoding='utf-8')
...
def clean():
    file_read_object = open('django_answers_keyword_tfidf.txt', 'r', encoding='utf-8')
    file_write_object = open('keyword_tfidf.txt', 'w', encoding='utf-8')
    for word_line in file_read_object:
        word_line=word_line.strip('\n')
        if word_line not in bad_noun_word:
            file_write_object.write(word_line+ "\n")
...
if __name__ == '__main__':
    ...
    # store_txt(db,"python_standard_test")
